...
function showBilling() {
    ...
    panel.innerHTML = `
            ...
            <div style="width: 100%; max-width: 1000px; margin: auto; border: 2px solid #edb92e; border-radius: 15px; padding: 20px; background: #1a2233; box-sizing: border-box;">
                ...
                <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 15px; margin-bottom: 12px;">
                    ...
                    <div>
                        ...
                        <input type="text" id="m_remark" placeholder="Note" style="width: 100%; padding: 10px; margin-top: 5px; border-radius: 8px; border:none; box-sizing: border-box;">
                    </div>
                </div>
                    ...
                    <div style="width: 100%; max-width: 400px; border: 2px solid #edb92e; padding: 20px; border-radius: 15px; background: #252e42;">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 8px;">
                            <div style="display: flex; align-items: center; gap: 8px;">
                                <input type="checkbox" id="gst_check" onchange="calculateTotal()" style="width:18px; height:18px;">
                ...
                <div id="signature-area" style="margin-top: 60px; display: flex; justify-content: space-between; padding: 0 20px;">
                    <div style="text-align: center;">
                        <p style="margin-bottom: 40px; border-top: 1px solid #777; width: 150px;"></p>
                        <p style="font-size: 12px;">Customer Signature</p>
                    </div>
                    <div style="text-align: center;">
                        <p style="margin-bottom: 40px; border-top: 1px solid #777; width: 150px;"></p>
                        <p style="font-size: 12px;">For S.R. Enterprises</p>
                    </div>
                </div>
        ...
        <style>
            @media print {
                #no-print, #no-print-back, button { display: none !important; }
...
function addNewRow() {
    ...
    row.innerHTML = `
        <input type="text" placeholder="Work description" style="padding: 10px; border-radius: 5px; border:none; width:100%; box-sizing:border-box;">
        ...
        <input type="number" class="item-qty" value="1" oninput="calculateTotal()" style="padding: 10px; border-radius: 5px; border:none; text-align: center; width:60px;">
