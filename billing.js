...
function showBilling() {
    ...
    panel.innerHTML = `
        <style>
            ...
            .update-box { border: 2px solid #16a34a; background: #f0fdf4; padding: 15px; border-radius: 10px; margin-top: 30px; box-shadow: 0 2px 5px rgba(0,0,0,0.1); }
        ...
        <div id="print-area" style="padding: 10px; color: #000; font-family: sans-serif; box-sizing: border-box; display: flex; flex-direction: column; align-items: center;">
            ...
            <div class="no-print update-box" style="width: 100%; max-width: 1050px; box-sizing: border-box;">
                ...
                <div style="display: grid; grid-template-columns: 1.5fr 1fr 1fr auto; gap: 15px; align-items: end;">
                    <div>
                        <label style="font-size: 12px; font-weight: 900;">MOBILE NO</label><br>
                        <input type="number" id="upd_mobile" placeholder="Enter Mobile" style="padding: 10px; border: 1px solid #ccc; border-radius: 5px; width: 100%;" onblur="fetchForUpdate(this.value)">
                    </div>
                    <div>
                        <label style="font-size: 12px; font-weight: 900; color:red;">DUE: ₹<span id="upd_due_val">0</span></label><br>
                        <div style="padding: 10px; background: #fff; border: 1px solid #ddd; border-radius: 5px; text-align: center; font-weight:900;">BALANCE INFO</div>
                    </div>
                    <div>
                        <label style="font-size: 12px; font-weight: 900;">PAID NOW (₹)</label><br>
                    ...
                    <button onclick="updatePaymentOnly()" style="background: #16a34a; color: white; padding: 12px 20px; border: none; border-radius: 5px; font-weight: 900; cursor: pointer; height: 45px;">UPDATE NOW</button>
                </div>
            </div>
        </div>
    `;
...
async function updatePaymentOnly() {
    ...
    const data = {
        ...
        mobile: mobile,
        paid: additionalPaid,
        newBalance: (currentDue - additionalPaid).toFixed(2)
    };
